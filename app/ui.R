    ...
    tabItems(
      ...
      tabItem(tabName = "ts",
              navbarPageUI(
                id="TS",
                hc=TRUE,
                title="Time Series (TS)")), # tabItem
      tabItem(tabName = "fft",
              navbarPageUI(
                id="FFT",
                hc=TRUE,
                title="Fast Fourier Transform (FFT)")), # tabItem
      tabItem(tabName = "stft",
              navbarPageUI(
                id="STFT",
                hc=FALSE,
                title="Short-Time Fourier Transform (STFT)")), # tabItem
      tabItem(tabName = "wtc",
              navbarPageUI(
                id="WTC",
                hc=FALSE,
                title="Continuous Wavelet Transform (CWT)")), # tabItem
      tabItem(tabName = "sdof",
              navbarPageUI(
                id="SDOF",
                hc=TRUE,
                title="Single Degree of Freedom (SDOF)")), # tabItem
      tabItem(tabName = "emd",
              navbarPageUI(
                id="EMD",
                hc=TRUE,
                title="Empirical Mode Decomposition (EMD)")) #tabItem
